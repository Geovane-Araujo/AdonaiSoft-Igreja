...
public class TabelaVisitantes extends javax.swing.JPanel {
    ...
    public void historico(String sql) throws SQLException {
    ...
    private void AtualizarHistoricoBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AtualizarHistoricoBuscarActionPerformed
        try {                                                         
            ...
            Logger.getLogger(TabelaVisitantes.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void Povoar() throws SQLException {
        String sql = "Select Max(codigovisitante) as max,min(codigovisitante) as min from visitantes";
        Connection con = conectar.Conectar();
        PreparedStatement stmt = null;
        ResultSet rs = null;
    ...
    public void Povoarhistorico() throws SQLException {
        String sql = "Select Max(codigovisitante)as max,min(codigovisitante)as min from HistoricoVisita";
        Connection con = conectar.Conectar();
        PreparedStatement stmt = null;
        ResultSet rs = null;
