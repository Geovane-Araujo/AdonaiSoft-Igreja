...
public class TabelaMembros extends javax.swing.JPanel {
    ...
    public void ContarMembros() throws SQLException{
        
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        String sql = "SELECT COUNT(Ativo) as ativo FROM Membros ";
    ...
    public int ContarAtivos() throws SQLException{
        ...
        PreparedStatement stmt = null;
        ResultSet rs = null;
        String sql = "SELECT COUNT(Ativo)as ativo FROM Membros WHERE Ativo = 1";
    ...
    public int ContarInativos() throws SQLException{
        int total = 0;
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        String sql = "SELECT COUNT(Ativo)as ativo FROM Membros WHERE Ativo = 0";
    ...
    public void preencher(String sql) throws SQLException{
        Connection con = null;
        PreparedStatement stmt = null;
        try{
            con = conectar.Conectar();
    ...
    private void initComponents() {
        ...
        CampoPaginacao = new javax.swing.JTextField();
        ...
        CampoPaginacao.setEditable(false);
        CampoPaginacao.setBackground(new java.awt.Color(219, 230, 244));
        CampoPaginacao.setForeground(new java.awt.Color(0, 0, 0));
        CampoPaginacao.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        CampoPaginacao.setText("1");
        CampoPaginacao.setBorder(null);
        CampoPaginacao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CampoPaginacaoActionPerformed(evt);
            }
        });
        CampoPaginacao.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                CampoPaginacaoKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(CampoPaginacao, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void FrenteBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FrenteBuscarActionPerformed
        ...
        try {
            int pagina = Integer.parseInt(CampoPaginacao.getText());
            
            String sql = "SELECT CodigoMembro,NomeCompleto,DataNascimento,Telefone,Endereco,Bairro,Cidade FROM Membros\n"
                    + " ORDER BY CodigoMembro DESC LIMIT 15 OFFSET("+pagina+" -1)* 15";
            preencher(sql);
            CampoPaginacao.setText(String.valueOf(pagina+1));
            paginacao();
        } catch (SQLException ex) {
            Logger.getLogger(TabelaMembros.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void CampoPaginacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CampoPaginacaoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CampoPaginacaoActionPerformed

    private void CampoPaginacaoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CampoPaginacaoKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_CampoPaginacaoKeyTyped
    ...
    public void mimx() {
        String sql = "Select Max(CodigoMembro)as max,min(CodigoMembro)as min from Membros";
    ...
    public static javax.swing.JTextField CampoPaginacao;
