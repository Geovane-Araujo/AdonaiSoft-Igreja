...
public class Relatorios {
    ...
    public void CarteiraMembro() throws JRException, IOException, SQLException{
        ...
        try{
            ...
            JasperPrint print = JasperFillManager.fillReport("C:/AdonaiSoft Igreja/Relatorios/CarteiraMembro.jasper", new HashMap(), jrrs);
    ...
    public void MultiplosCarteirinha() throws JRException, IOException, SQLException{
        String sql = "SELECT\n" +
        ...
        try{
            ...
            JRResultSetDataSource jrrs = new JRResultSetDataSource(rs);
            JasperPrint print = JasperFillManager.fillReport("C:/AdonaiSoft Igreja/Relatorios/Carteira.jasper", new HashMap(), jrrs);
    ...
    public void Dizimistas() throws JRException, IOException, SQLException{
        String sql = "SELECT \n" +
                    "   Duplicatas.DataC,\n" +
                    "	Duplicatas.valor,\n" +
                    "	Membros.Nomecompleto,\n" +
        ...
        try{
            ...
            JRResultSetDataSource jrrs = new JRResultSetDataSource(rs);
            JasperPrint print = JasperFillManager.fillReport("C:/AdonaiSoft Igreja/Relatorios/dizimo.jasper", new HashMap(), jrrs);
    ...
    public void Certificado() throws JRException, IOException, SQLException{
         String sql = "SELECT\n" +
                    "\n" +
                    "     membros.nomecompleto,\n" +
                    "     configuracoes.pastorpresidente,\n" +
        ...
        try{
            ...
            JRResultSetDataSource jrrs = new JRResultSetDataSource(rs);
            JasperPrint print = JasperFillManager.fillReport("C:/AdonaiSoft Igreja/Relatorios/Certificado2.jasper", new HashMap(), jrrs);
    ...
    public void Caixas() throws JRException, IOException, SQLException{
        ...
        try{
            ...
            JRResultSetDataSource jrrs = new JRResultSetDataSource(rs);
            JasperPrint print = JasperFillManager.fillReport("C:/AdonaiSoft Igreja/Relatorios/Caixas.jasper", new HashMap(), jrrs);
    ...
    public void Entradas() throws JRException, IOException, SQLException{
        ...
        try{
            ...
            JRResultSetDataSource jrrs = new JRResultSetDataSource(rs);
            JasperPrint print = JasperFillManager.fillReport("C:/AdonaiSoft Igreja/Relatorios/Entradas.jasper", new HashMap(), jrrs);
    ...
    public void Despesas() throws JRException, IOException, SQLException{
        ...
        try{
            ...
            JRResultSetDataSource jrrs = new JRResultSetDataSource(rs);
            JasperPrint print = JasperFillManager.fillReport("C:/AdonaiSoft Igreja/Relatorios/Despesas.jasper", new HashMap(), jrrs);
    ...
    public void CartaApresentacao(String sql) throws JRException, IOException, SQLException{
        Connection con = conectar.Conectar();
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        try{
            ...
            JRResultSetDataSource jrrs = new JRResultSetDataSource(rs);
            JasperPrint print = JasperFillManager.fillReport("C:/AdonaiSoft Igreja/Relatorios/CartaApresentacao.jasper", new HashMap(), jrrs);
    ...
    public void CartaMudanca(String sql) throws JRException, IOException, SQLException{
        Connection con = conectar.Conectar();
        PreparedStatement stmt = null;
        ResultSet rs = null;
        ...
        try{
            ...
            JRResultSetDataSource jrrs = new JRResultSetDataSource(rs);
            JasperPrint print = JasperFillManager.fillReport("C:/AdonaiSoft Igreja/Relatorios/CartaMudanca.jasper", new HashMap(), jrrs);
