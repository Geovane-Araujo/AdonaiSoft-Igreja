...
public class ClasseConfiguracoes {
    ...
    public void InserirIgreja() throws SQLException{
        Connection con = null;
    ...
    public void AlterarConfiguraçoes() throws SQLException{// alterar aqui depois
        Connection con = null;
        PreparedStatement stmt = null;
    ...
    public void pedirsenha() throws SQLException{
